<template>
	<footer class="footer">
		...
		<div class="copyright">© {{ year }} dieWehmut's Group · <a href="#third-party-notice" @click.prevent="onThirdPartyClick" class="third-party-link">Third-Party Notice</a></div>
	</footer>
</template>
...
function onThirdPartyClick() {
    emit('scrollTo', 'third-party-notice')
}
